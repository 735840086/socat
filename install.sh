...
if [ "$lang_choice" = "2" ]; then
    ...
    prompt_install="1. 安装"
    prompt_update="⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️"
    prompt_start="2. 启动"
    prompt_stop="3. 停止"
    prompt_restart="4. 重启"
    prompt_port="⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️"
    prompt_ulimit="5. 解除连接限制"
    prompt_auto_start="6. 开机启动"
    prompt_disable_auto_start="7. 关闭开机启动"
    prompt_status="8. 运行状态"
    prompt_error_log="⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️"
    prompt_clear_log="9. 清理日志"
    prompt_web_port="⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️"
    prompt_uninstall="10. 卸载"
    prompt_reset_pwd="11. 重置密码"
    prompt_target_version="⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️"
...
start() {
    ...
    if [ $? -eq 0 ]; then
        ...
        if [ $? -eq 0 ]; then
            ...
            echo -e ""
            echo -e "⭐️地址端口:     ${BOLD}${GREEN}${http_h}$(get_ip):${port}${RESET}"
