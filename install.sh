...
load_language() {
    ...
    1)
        ...
        menu_group_install="部署"
        menu_group_runtime="控制"
        menu_group_settings="配置"
        menu_group_logs="日志"
        menu_group_maintenance="维护"
        menu_group_cli="WeChat:735840086"
        menu_tip="提示：解除系统连接数限制需重启服务器后生效"
        ...
        msg_started_title="cocatsystem启动成功"
        ...
        msg_http_tip="当前为HTTP协议"
        msg_https_tip="当前为HTTPS协议"
